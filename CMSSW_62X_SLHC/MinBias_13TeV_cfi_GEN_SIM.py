...
# with command line options: MinBias_13TeV_cfi -s GEN,SIM --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_phase2_BE5D,SimG4Core/Application/NeutronBGforMuonsXS_cff.customise --pileup=NoPileUp --geometry Extended2023,Extended2023Reco --magField 38T_PostLS1 --conditions auto:upgradePLS3 --eventcontent=RAWSIM --datatier GEN-SIM --dirout=./ -n 250 --fileout file:mb_13TeV_2023_mu_xs.root --mc --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('./file:mb_13TeV_2023_mu_xs.root'),
